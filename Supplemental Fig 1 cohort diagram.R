...
start.total<- enclave.analysis %>%
  count()
c<- c +
  geom_rect(xmin = 50, xmax=150, ymin=220, ymax=230, color="#037377",
            fill='#ebf4f1', size=0.25) +
...
c<- c +
  geom_rect(xmin = 50, xmax=150, ymin=190, ymax=200, color="#037377",
            fill='#ebf4f1', size=0.25) +
  ...
  geom_rect(xmin = 125, xmax=182, ymin=205, ymax=215, color="#037377",
...
c<- c +
  geom_rect(xmin = 50, xmax=150, ymin=160, ymax=170, color="#037377",
            fill='#ebf4f1', size=0.25) +
  ...
  geom_rect(xmin = 125, xmax=182, ymin=175, ymax=185, color="#037377",
            fill='white', size=0.25) +
...
c<- c +
  geom_rect(xmin = 35, xmax=85, ymin=110, ymax=130, color="#037377",
            fill='#ebf4f1', size=0.25) +
  ...
  geom_rect(xmin = 115, xmax=165, ymin= 110, ymax=130, color="#037377",
            fill='#ebf4f1', size=0.25)+
...
ggsave("Cohort diagram supplemental Fig 1.pdf", width = 8, height = 8, dpi = 600, bg = "white")
